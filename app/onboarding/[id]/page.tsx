...
const onboardingSteps: OnboardingStep[] = [
  {
    ...
    description: 'Enter your company name, business address, and contact information',
    completed: true
  },
  {
    id: '2',
    title: 'Business documents',
    description: 'Upload incorporation documents, licenses, and previous tax returns',
    completed: false
  },
  {
    id: '3',
  ...
  },
  {
    id: '4',
    title: 'Connections',
    description: 'Integrate with your accounting, payment processing, and payroll systems',
    completed: false
  },
  {
    id: '5',
    title: 'Set up advisor kickoff call',
    description: 'Schedule your first meeting with your dedicated tax advisor',
    completed: false
  }
];
  ...
  return (
    <>
      ...
      <div className="mt-8 flex justify-end">
        <button 
          className="bg-gray-900 text-white px-4 py-2 rounded-lg text-[13px] font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => {
            // Handle continue
          }}
...
export default function OnboardingStepPage({ params }: { params: Promise<PageParams> }) {
  const router = useRouter();
  const { user } = useAuth();
  const resolvedParams = use(params);
  
  const currentStep = onboardingSteps.find(step => step.id === resolvedParams.id);
      ...
      <div className="flex-1 p-4 pl-0 bg-[#F5F6F8] overflow-hidden">
        <main className="h-full rounded-xl bg-white overflow-y-auto">
          <div className="px-[48px] py-4 mt-6">
            ...
            <h1 className="text-[18px] font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <Link 
                href="/onboarding"
              ...
              <span className="text-gray-500">{currentStep.title}</span>
            </h1>
            ...
            <div>
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      <h2 className="text-[15px] font-medium text-gray-600 mb-4">
                        {currentStep.id === '3' ? 'Package' : currentStep.title}
                      </h2>
                  ...
                  {resolvedParams.id === '3' && <PackageCards />}
                </div>
              </div>
            </div>
          </div>

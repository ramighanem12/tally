...
export default function UploadNoticeModal({ isOpen, onClose }: UploadNoticeModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[440px] bg-white rounded-xl py-4 px-6 shadow-xl animate-modalSlideIn">
        ...
        <p className="text-[14px] leading-[20px] font-normal font-['Inter'] text-[#1A1A1A] mb-6">
          Upload a notice or document from a tax authority. We'll help you understand what action is needed.
        </p>

        {/* Upload area */}
        <div 
          {...getRootProps()} 
          className={`border-2 border-dashed rounded-lg p-6 mb-6 text-center transition-colors cursor-pointer
